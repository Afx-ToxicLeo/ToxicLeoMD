...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.packname = 'TOXICLEO-MD'
        global.author = ' *??x?? ???* '
        global.packname2 = 'Made With'
        global.author2 = 'Akash'
        global.wm3 = '·͟͟͟͟͟͟͞͞͞͞͞͞Made By Claraa˚'
        global.wm2 = '©𝙍𝙖𝙖-𝘽𝙤𝙩𝙯-𝙈𝘿' + ' ' + 'By 𝐂𝐥𝐚𝐫𝐚𝐚'
        global.wm = '© 𝙍𝙖𝙖-𝘽𝙤𝙩𝙯--𝙈𝘿'
        global.colong1 = 'Ciss 📸'
        global.colong2 = 'ByToxicLeo'
        global.kontak2 = [
        ['919497206865', 'Claraa', 'Creator Bot', 'Clarz939@support.com', true],
        ['919497206865', 'TOXICLEO-MD', 'Bot WhatsApp', 'Just Bot', true]
        ]
...
global.dfail = async (type, m, conn) => {
    ...
    let msg = {
        rowner: 'This command can only be used by _*Team Bot Discussion!1!1!*_',
         ...
         nsfw: 'NSFW is not active, please contact the Team Bot Discussion to activate this feature!',
         rpg: 'RPG is not active, please contact Team Bot Discussion to activate this feature!',
